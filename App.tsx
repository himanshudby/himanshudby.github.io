                      ...
                      {blogPosts.map((post) => (
                        ...
                        >
                          ...
                          <div className="relative z-10">
                            {/* Optional: Blog List Thumbnail */}
                            {post.image && (
                              <div className="w-full h-48 rounded-2xl bg-cover bg-center mb-6 border border-white/50 shadow-sm" style={{ backgroundImage: `url(${post.image})` }}></div>
                            )}
                   ...
                   <div className="animate-in fade-in slide-in-from-right-8 duration-500">
                       ...
                       <article className="bg-white/50 rounded-3xl p-8 sm:p-10 border border-white/60 relative overflow-hidden">
                           ...
                           <div className="mb-8 border-b border-slate-200/60 pb-8">
                               ...
                               {/* Cover Image - Displayed if 'image' property exists */}
                               {selectedPost.image && (
                                 <div className="w-full h-[300px] sm:h-[400px] rounded-2xl bg-cover bg-center shadow-md border border-white/50 mb-8" style={{ backgroundImage: `url(${selectedPost.image})` }}></div>
                               )}
                           </div>
                           ...
                           {isPostLoading ? (
                               ...
                               <div className="prose prose-lg prose-slate max-w-none prose-headings:text-slate-800 prose-headings:font-bold prose-a:text-indigo-600 prose-img:rounded-2xl prose-img:shadow-lg prose-img:border prose-img:border-slate-200 prose-pre:bg-slate-800 prose-pre:text-slate-100 prose-pre:rounded-xl">
                                   {/* Custom Image Renderer for Markdown Screenshots */}
                                   <ReactMarkdown
                                     components={{
                                       img: ({node, ...props}) => (
                                         <img 
                                           {...props} 
                                           className="rounded-xl shadow-lg border border-slate-200 my-6 w-full object-cover bg-white"
                                           loading="lazy"
                                         />
                                       )
                                     }}
